package com.As.mMertTopal.weather.controller.validation;
...
public class CityParameterValidator implements ConstraintValidator<CityNameConstraint, String> {
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        ...
        if (!isValid) {
            context.disableDefaultConstraintViolation(); // Öntanımlı kısıtlama ihlali bildirimlerini devre dışı bırak
            context.buildConstraintViolationWithTemplate("Your custom message here")
                    .addConstraintViolation(); // Özel bildirimi ekle
